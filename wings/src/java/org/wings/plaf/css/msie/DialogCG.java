...
public final class DialogCG extends org.wings.plaf.css.DialogCG {
    ...
    public void writeInternal(final Device device, final SComponent _c) throws IOException {
        ...
        // MSIE has a bug that makes in impossible to overlay Comboboxes with other widgets.
        //  The intention of this code seems to turn off / hide all existing comboboxes, so that they do not destroy the dialogs layout.
